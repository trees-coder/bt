...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <!-- 内容头部 /-->
        <form action="${pageContext.request.contextPath}/sellers/save.do" method="post">
            <!-- 正文区域 -->
                ...
                <div class="panel panel-default">
                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="sname" placeholder="商家名称" autocomplete="off" value="">
                        </div>
                        <div class="col-md-2 title">商家电话</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="consphone" placeholder="商家电话" autocomplete="off" value="">
                        </div>
                    </div>
                    <div class="row data-type">
                        <div class="col-md-2 title">商家地址</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="address" placeholder="商家地址" autocomplete="off" value="">
                        </div>
