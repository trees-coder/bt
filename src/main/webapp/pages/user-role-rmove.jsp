    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">移除角色表单</li>
            </ol>
        </section>
        <!-- 内容头部 /-->

        <form action="${pageContext.request.contextPath}/users/removeRole.do" method="post">
            <!-- 正文区域 -->
            <section class="content">
                ...
                <table id="dataList"
                    ...
                    <c:forEach items="${roleList}" var="role">
                        <tr>
                            <td>
                                <input name="ids" class="icheckbox_square-blue" type="checkbox" value="${role.id}">
                            </td>
                            <td>${role.id}</td>
                            <td>${role.roleName }</td>
                            <td>${role.roleDesc}</td>
