                    ...
                    <div class="table-box" style="min-height: 501px;">
                        ...
                        <div class="box-tools pull-right">
                            <div class="has-feedback" >
                                <form class="search_form" action="${pageContext.request.contextPath}/roles/findAll.do" method="post">
                                    <input type="submit" value="搜索" class="input_sub">
                                    <input type="text" name="roleName" class="form-control input-sm" style="width:190px;height: 30px;float:right;" placeholder="请输入搜索内容" autocomplete="off">
                                </form>
                            </div>
                        </div>
                        <!--工具栏/-->
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <c:forEach items="${pageInfo.list}" var="role">
                                <tr>
                                    ...
                                    <td style="text-align: center;">${role.roleDesc }</td>
                                    <td class="text-center">
                                        <a href="${pageContext.request.contextPath}/roles/findById.do?id=${role.id}" class="btn btn-info btn-xs">详情</a>
                                        <button type="button" class="btn btn-danger btn-xs"
                                                onclick="if(confirm('您确定删除吗？')){location.href='${pageContext.request.contextPath}/roles/deleteRole.do?id=${role.id}'}">删除角色</button>
                                        <a href="${pageContext.request.contextPath}/roles/findRoleByIdAndAllPermission.do?id=${role.id}" class="btn btn-success btn-xs">添加权限</a>
                                        <a href="${pageContext.request.contextPath}/roles/findPermissionByRoleId.do?roleId=${role.id}" class="btn btn-warning btn-xs">移除权限</a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
                ...
                <div class="box-footer" style="padding: 0 30px 0 20px">
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination" style="margin: 0px">
                            <li>
                                <a href="${pageContext.request.contextPath}/roles/findAll.do?page=1" aria-label="Previous">首页</a>
                            </li>
                            <li><a href="${pageContext.request.contextPath}/roles/findAll.do?page=${pageInfo.pageNum-1}">上一页</a></li>
                            <!--中间页码开始-->
                            <c:if test="${pageInfo.pages < 10}">
                                <c:forEach begin="1" end="${pageInfo.pages}" var="pageNum">
                                    <li><a href="${pageContext.request.contextPath}/roles/findAll.do?page=${pageNum}">${pageNum}</a></li>
                                </c:forEach>
                            </c:if>
                            <c:if test="${pageInfo.pages >= 10}">
                            ...
                            <!--中间页码结束-->
                            <li><a href="${pageContext.request.contextPath}/roles/findAll.do?page=${pageInfo.pageNum+1}">下一页</a></li>
                            <li>
                                <a href="${pageContext.request.contextPath}/roles/findAll.do?page=${pageInfo.pages}" aria-label="Next">尾页</a>
                            </li>
                        </ul>
                    </div>
