            ...
            <div class="box-body">
                ...
                <div class="tab-pane" id="tab-treetable">
                    <table id="collapse-table" class="table table-bordered table-hover dataTable">
                        ...
                        <tr data-tt-id="0">
                            <td colspan="2">${hotel.hname}</td>
                        </tr>
                        <tbody>
                        <tr data-tt-id="${vs.index+1}" data-tt-parent-id="0">
                            <th style="padding-left: 45px;">房型</th>
                            <th>价格</th>
                        </tr>
                        <c:forEach items="${details}" var="room" varStatus="vs">
                            <tr data-tt-id="${vs.index+1}" data-tt-parent-id="0">
                                <td>${room.hoteltype.tname}</td>
                                <td>${room.price}元</td>
                            </tr>
                        </c:forEach>
                        </tbody>
