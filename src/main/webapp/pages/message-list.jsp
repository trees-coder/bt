                    ...
                    <div class="table-box" style="min-height: 501px;">
                            ...
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-default" title="新建"
                                            onclick="location.href='${pageContext.request.contextPath}/pages/message-add.jsp'">
                        ...
                        <div class="box-tools pull-right">
                            <div class="has-feedback" >
                                <form class="search_form" action="${pageContext.request.contextPath}/messages/findAll.do" method="post">
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tr style="background: lightsteelblue;">
                                ...
                                <th style="text-align: center;width: 150px;">留言标题</th>
                                <th style="text-align: center;">留言内容</th>
                                <th style="text-align: center;width: 60px;">留言时间</th>
                            ...
                            <c:forEach items="${pageInfo.list}" var="message">
                                <tr>
                                    <td style="word-wrap:break-word;text-align: center;">${message.mid }</td>
                                    <td style="word-wrap:break-word;">${message.title }</td>
                                    <td style="word-wrap:break-word;">${message.content }</td>
                                    <td style="word-wrap:break-word;">${message.datetime }</td>
                                    <td style="word-wrap:break-word;text-align: center;">${message.user.username }</td>
                                    <td class="text-center">
                                        <button type="button" class="btn btn-danger btn-xs"
                                                onclick="if(confirm('您确定删除吗？')){location.href='${pageContext.request.contextPath}/messages/delete.do?mid=${message.mid}'}">删除</button>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
                ...
                <div class="box-footer" style="padding: 0 30px 0 20px">
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination" style="margin: 0px">
                            <li>
                                <a href="${pageContext.request.contextPath}/messages/findAll.do?page=1" aria-label="Previous">首页</a>
                            </li>
                            <li><a href="${pageContext.request.contextPath}/messages/findAll.do?page=${pageInfo.pageNum-1}">上一页</a></li>
                            <!--中间页码开始-->
                            <c:if test="${pageInfo.pages < 10}">
                                <c:forEach begin="1" end="${pageInfo.pages}" var="pageNum">
                                    <li><a href="${pageContext.request.contextPath}/messages/findAll.do?page=${pageNum}">${pageNum}</a></li>
                                </c:forEach>
                            </c:if>
                            <c:if test="${pageInfo.pages >= 10}">
                            ...
                            <!--中间页码结束-->
                            <li><a href="${pageContext.request.contextPath}/messages/findAll.do?page=${pageInfo.pageNum+1}">下一页</a></li>
                            <li>
                                <a href="${pageContext.request.contextPath}/messages/findAll.do?page=${pageInfo.pages}" aria-label="Next">尾页</a>
                            </li>
                        </ul>
                    </div>
