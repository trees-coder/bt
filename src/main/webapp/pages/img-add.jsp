    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a id="detail" href="">详情图片</a></li>
                <li class="active">新增图片</li>
            </ol>
        </section>
        <!-- 内容头部 /-->
        <form action="${pageContext.request.contextPath}/images/save.do" method="post" enctype="multipart/form-data">
            ...
            <section class="content">
                <div class="panel panel-default">
                    ...
                    <div class="row data-type">
                        <div class="col-md-2 title" style="height: 250px;padding: 100px 0;">详情大图</div>
                        <div class="col-md-4 data" style="height: 250px;">
                            <div style="width: 400px;height: 100%;float:left;">
                                <div id="big" style="width: 276px;height: 164px;margin: 10px 0 0 50px;border: 1px solid #fcc;"></div>
                                <input id="bigFile" type="file" name="bigFile" style="margin: 20px 0 0 50px;" onchange="change(this)">
                            </div>
                        </div>
                        <div class="col-md-2 title" style="height: 250px;padding: 100px 0;">详情小图</div>
                        <div class="col-md-4 data" style="height:250px;">
                            <div style="width: 400px;height: 100%;float:left;">
                                <div id="small" style="width: 276px;height: 164px;margin: 10px 0 0 50px;border: 1px solid #fcc;"></div>
                                <input id="smallFile" type="file" name="smallFile" style="margin: 20px 0 0 50px;" onchange="change(this)">
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    $(function () {
        ...
        $("#detail").attr("href","${pageContext.request.contextPath}/images/findImgByRid.do?rid="+rid);
        $("#rid").attr("value",rid);
    });
    ...
    function change(obj) {
        ...
        if(obj.id=="smallFile"){
            var file = document.getElementById("smallFile").files[0];
            var reader = new FileReader();
            reader.readAsDataURL(file);
            reader.onload = function () {
