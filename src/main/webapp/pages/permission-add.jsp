                ...
                <div class="panel panel-default">
                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="permissionName" placeholder="权限名称" autocomplete="off" value="">
                        </div>
                        <div class="col-md-2 title">权限路径</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="url" placeholder="权限路径" autocomplete="off" value="">
                        </div>
                    </div>
                </div>
                <!--订单信息/--> <!--工具栏-->
