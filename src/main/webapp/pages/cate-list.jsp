						...
						<div class="table-box" style="min-height: 501px;">
								...
								<div class="form-group form-inline">
									<div class="btn-group">
										<button type="button" class="btn btn-default" title="新建"
											onclick="location.href='${pageContext.request.contextPath}/pages/cate-add.jsp'">
							...
							<div class="box-tools pull-right">
								<div class="has-feedback" >
									<form class="search_form" action="${pageContext.request.contextPath}/cates/findAll.do" method="post">
										<input type="submit" value="搜索" class="input_sub">
										<input type="text" name="cname" class="form-control input-sm" style="width:190px;height: 30px;float:right;" placeholder="请输入搜索内容" autocomplete="off">
									</form>
								</div>
							</div>
							<!--工具栏/-->
							...
							<!--数据列表-->
								...
								<tbody>
									<c:forEach items="${pageInfo.list}" var="cate">
										<tr>
											<td style="word-wrap:break-word;text-align: center;">${cate.cid }</td>
											<td style="word-wrap:break-word;text-align: center;">${cate.cname }</td>
											<td class="text-center">
												<button type="button" class="btn btn-primary btn-xs"
													onclick="location.href='${pageContext.request.contextPath}/cates/findByCid.do?cid=${cate.cid}'">修改</button>
												<button type="button" class="btn btn-danger btn-xs"
													onclick="if(confirm('您确定删除吗？')){location.href='${pageContext.request.contextPath}/cates/delete.do?cid=${cate.cid}'}">删除</button>
											</td>
										</tr>
									</c:forEach>
								</tbody>
					...
					<div class="box-footer" style="padding: 0 30px 0 20px">
						...
						<div class="box-tools pull-right">
							<ul class="pagination" style="margin: 0px">
								<li>
									<a href="${pageContext.request.contextPath}/cates/findAll.do?page=1" aria-label="Previous">首页</a>
								</li>
								<li><a href="${pageContext.request.contextPath}/cates/findAll.do?page=${pageInfo.pageNum-1}">上一页</a></li>
								<!--中间页码开始-->
								<c:if test="${pageInfo.pages < 10}">
									<c:forEach begin="1" end="${pageInfo.pages}" var="pageNum">
										<li><a href="${pageContext.request.contextPath}/cates/findAll.do?page=${pageNum}">${pageNum}</a></li>
									</c:forEach>
								</c:if>
								<c:if test="${pageInfo.pages >= 10}">
								...
								<!--中间页码结束-->
								<li><a href="${pageContext.request.contextPath}/cates/findAll.do?page=${pageInfo.pageNum+1}">下一页</a></li>
								<li>
									<a href="${pageContext.request.contextPath}/cates/findAll.do?page=${pageInfo.pages}" aria-label="Next">尾页</a>
								</li>
							</ul>
						</div>
