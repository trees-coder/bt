...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <!-- 内容头部 /-->
        <form action="${pageContext.request.contextPath}/hotels/save.do" method="post" enctype="multipart/form-data">
            <!-- 正文区域 -->
                ...
                <div class="panel panel-default">
                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="hname" placeholder="酒店名称" autocomplete="off" value="">
                        </div>
                    </div>
                    <div class="row data-type">
                        <div class="col-md-2 title" style="height: 250px;padding: 100px 0;">酒店介绍</div>
                        <div class="col-md-4 data" style="height: 250px;">
                            <textarea id="content" name="hintroduce" class="form-control" rows="10" placeholder="酒店介绍" autocomplete="off" style="margin-top: 10px;"></textarea>
                        </div>
                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="address" placeholder="酒店地址" autocomplete="off" value="">
                        </div>
                        <div class="col-md-2 title">酒店电话</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="telphone" placeholder="酒店电话" autocomplete="off" value="">
                        </div>
                    </div>
                    <div class="row data-type">
