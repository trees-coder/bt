                    ...
                    <div class="table-box" style="min-height: 501px;">
                        ...
                        <div class="box-tools pull-right">
                            <div class="has-feedback" >
                                <form class="search_form" action="${pageContext.request.contextPath}/permission/findAll.do" method="post">
                                    <input type="submit" value="搜索" class="input_sub">
                                    <input type="text" name="permissionName" class="form-control input-sm" style="width:190px;height: 30px;float:right;" placeholder="请输入搜索内容" autocomplete="off">
                                </form>
                            </div>
                        </div>
                        <!--工具栏/-->
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tr style="background: lightsteelblue;">
                                ...
                                <th style="text-align: center;">权限路径</th>
                            ...
                            <c:forEach items="${pageInfo.list}" var="permission">
                                <tr>
                                    ...
                                    <td style="text-align: center;">${permission.permissionName }</td>
                                    <td style="text-align: center;">${permission.url }</td>
                                    <td class="text-center">
                                        <a href="${pageContext.request.contextPath}/permission/findById.do?id=${permission.id}" class="btn btn-primary btn-xs">修改</a>
                                        <button type="button" class="btn btn-danger btn-xs"
                                                onclick="if(confirm('您确定删除吗？')){location.href='${pageContext.request.contextPath}/permission/deletePermission.do?id=${permission.id}'}">删除</button>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
                ...
                <div class="box-footer" style="padding: 0 30px 0 20px">
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination" style="margin: 0px">
                            <li>
                                <a href="${pageContext.request.contextPath}/permission/findAll.do?page=1" aria-label="Previous">首页</a>
                            </li>
                            <li><a href="${pageContext.request.contextPath}/permission/findAll.do?page=${pageInfo.pageNum-1}">上一页</a></li>
                            <!--中间页码开始-->
                            <c:if test="${pageInfo.pages < 10}">
                                <c:forEach begin="1" end="${pageInfo.pages}" var="pageNum">
                                    <li><a href="${pageContext.request.contextPath}/permission/findAll.do?page=${pageNum}">${pageNum}</a></li>
                                </c:forEach>
                            </c:if>
                            <c:if test="${pageInfo.pages >= 10}">
                            ...
                            <!--中间页码结束-->
                            <li><a href="${pageContext.request.contextPath}/permission/findAll.do?page=${pageInfo.pageNum+1}">下一页</a></li>
                            <li>
                                <a href="${pageContext.request.contextPath}/permission/findAll.do?page=${pageInfo.pages}" aria-label="Next">尾页</a>
                            </li>
                        </ul>
                    </div>
