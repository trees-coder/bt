                    ...
                    <div class="table-box" style="min-height: 501px;">
                        ...
                        <div class="box-tools pull-right">
                            <div class="has-feedback" >
                                <form class="search_form" action="${pageContext.request.contextPath}/orders/findAll.do" method="post">
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tr style="background: lightsteelblue;">
                                ...
                                <th style="text-align: center;">入住房型</th>
                                <th style="text-align: center;width: 60px;">入住人</th>
                                <th style="text-align: center;">联系电话</th>
                                <th style="text-align: center;">入住时间</th>
                                <th style="text-align: center;">离开时间</th>
                                <th style="text-align: center;width: 50px;">天数</th>
                            ...
                            <c:forEach items="${pageInfo.list}" var="order">
                                <tr>
                                    ...
                                    <td style="text-align: center;">${order.beginday }</td>
                                    <td style="text-align: center;">${order.endday }</td>
                                    <td style="text-align: center;">${order.totaldays }</td>
                                    <td style="text-align: center;">${order.paymoney }元</td>
                                    <td style="padding-left: 20px;">
                                        <button type="button" class="btn btn-danger btn-xs"
                                                onclick="if(confirm('您确定删除吗？')){location.href='${pageContext.request.contextPath}/orders/delete.do?id=${order.id}'}">删除</button>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
                ...
                <div class="box-footer" style="padding: 0 30px 0 20px">
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination" style="margin: 0px">
                            ...
                            <li><a href="${pageContext.request.contextPath}/orders/findAll.do?page=${pageInfo.pageNum-1}">上一页</a></li>
                            <!--中间页码开始-->
                            <c:if test="${pageInfo.pages < 10}">
                                <c:forEach begin="1" end="${pageInfo.pages}" var="pageNum">
                                    <li><a href="${pageContext.request.contextPath}/orders/findAll.do?page=${pageNum}">${pageNum}</a></li>
                                </c:forEach>
                            </c:if>
                            <c:if test="${pageInfo.pages >= 10}">
                            ...
                            <!--中间页码结束-->
                            <li><a href="${pageContext.request.contextPath}/orders/findAll.do?page=${pageInfo.pageNum+1}">下一页</a></li>
                            <li>
                                <a href="${pageContext.request.contextPath}/orders/findAll.do?page=${pageInfo.pages}" aria-label="Next">尾页</a>
                            </li>
                        </ul>
                    </div>
